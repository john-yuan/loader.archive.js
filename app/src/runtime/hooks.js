...
define(function (require, exports, module) {
    ...
    exports.getBaseCssText = function () {
        return [
            require('loader/plugin/text!./base.less'),
        ].join('\n');
    };
    ...
    exports.getWidgetContainer = function () {
        return document.getElementById('widgets');
    };
     ...
     * @param {Module} viewModule
     */
    exports.onCreateViewRootNode = function (rootNode, viewModule) {
     ...
     *
     * @param {Element} rootNode
     * @param {Module} widgetModule
     */
    exports.onCreateWidgetRootNode = function (rootNode, widgetModule) {
     ...
     * @returns {any}
     */
    exports.processQsValue = function (value, key) {
        if (value === '') {
            return null;
        } else if (value === 'false') {
            return false;
            ...
            return true;
        // 严格的数字匹配，示例: 12, 0.12, 32.14, -12, -0.12, -32.14
